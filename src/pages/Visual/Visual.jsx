...
const Visual = () => {
    ...
    const checkExchange = (addr) => {
        if(addr.startsWith('bc1qm')||addr.startsWith('1HDWA')){return 'Bitcoin Binance'}
        if(addr.startsWith('1NDy')){return 'Bitcoin Binance (deprecated)'}
        ...
        else if (addr.startsWith('0x618f')){return 'Ethereum Wazirx'}
    };
    ...
    return(
        ...
        <div className="container1">
            <div className="track">
                {(inputs.length>30||outputs.length>30) && <div className="sus">This transaction might be suspicious</div>}
                <button onClick={redirectToVisual}>View transaction flow</button>
            </div>
            <div className="txDets">
                <div className="txInputs">
                    <h2 className="out">Inputs: {inputs.length}</h2>
                ...
                <h2 className="out">Outputs: {outputs.length}</h2>
